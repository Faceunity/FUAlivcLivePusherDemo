...
- (void)setupSubviews {
    ...
    if(KIsiPhoneX) {
        self.publisherURLTextField.frame = CGRectMake(80, 70, viewWidth - 90, AlivcSizeHeight(25));
    }else {
        self.publisherURLTextField.frame = CGRectMake(80, 50, viewWidth - 90, AlivcSizeHeight(25));
    }
...
//    [self.view addSubview:fuswitch];
    ...
    self.publisherButton.frame = CGRectMake(20, 0, AlivcScreenWidth - 40, 50);
