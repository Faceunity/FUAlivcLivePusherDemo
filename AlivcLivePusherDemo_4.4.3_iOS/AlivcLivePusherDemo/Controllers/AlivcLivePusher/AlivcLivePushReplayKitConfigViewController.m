...
@interface AlivcLivePushReplayKitConfigViewController () <UITableViewDelegate, UITableViewDataSource, AlivcLivePusherInfoDelegate, AlivcLiveBaseObserver>
...
- (void)setupSubviews {
    ...
    if(KIsiPhoneX) {
        self.publisherURLTextField.frame = CGRectMake(retractX, 50, AlivcScreenWidth - 110, AlivcSizeHeight(30));
    }else {
        self.publisherURLTextField.frame = CGRectMake(retractX, 50, AlivcScreenWidth - 110, AlivcSizeHeight(30));
    }
