...
- (void)fetchData {
    ...
    AlivcMusicInfoModel *model0 = [[AlivcMusicInfoModel alloc] initWithMusicName:@"无音乐" musicPath:nil musicDuation:0.0 isLocal:YES];
    
    NSString *path1 = [[NSBundle mainBundle] pathForResource:@"Axol" ofType:@"mp3"];
    AlivcMusicInfoModel *model1 = [[AlivcMusicInfoModel alloc] initWithMusicName:@"Axol(APP资源)" musicPath:path1 musicDuation:0.0 isLocal:YES];
    
    NSString *path2 = [self getMusicPathWithMusicName:@"Pas de Deux"];
    
    AlivcMusicInfoModel *model2 = [[AlivcMusicInfoModel alloc] initWithMusicName:@"Pas de Deux(沙盒资源)" musicPath:path2 musicDuation:0.0 isLocal:YES];
    
    NSString *path3 = @"http://docs-aliyun.cn-hangzhou.oss.aliyun-inc.com/assets/attach/51991/cn_zh/1511776743437/JUST%202017.mp3";
    AlivcMusicInfoModel *model3 = [[AlivcMusicInfoModel alloc] initWithMusicName:@"网络音乐1" musicPath:path3 musicDuation:0.0 isLocal:NO];
