...
- (void)setupParamData {
   ...
   // userMainStream_userMixStreamModel.defaultValueAppose = 0.0;
    ...
    videoOnly_audioHardwareEncodeModel.defaultValue = 1.0;
